...
Architecture & Patterns: Feature-Sliced Design (FSD), SOLID, DRY, KISS
Tooling: Vite, Git (Gitflow), CI/CD (Vercel), npm/yarn
Styling & UX: CSS Modules, Framer Motion (Complex Animations), Responsive Design
